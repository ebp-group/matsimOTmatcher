 ...
 * @author mrieser
 */
public class MyTransitLoad implements TransitDriverStartsEventHandler, VehicleArrivesAtFacilityEventHandler, VehicleDepartsAtFacilityEventHandler, PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler {

	public final Map<Id<TransitLine>, LineData> lineData = new HashMap<>();

	public final Map<Id<Vehicle>, Id<TransitStopFacility>> vehicleFacilityMap = new HashMap<>();
	public final Map<Id<Vehicle>, VehicleData> vehicleData = new HashMap<>();

	public MyTransitLoad() {
	}
