...
public class TransitRouteStopImplNew implements TransitRouteStop {
	...
	public TransitRouteStopImplNew(Builder builder) {
		stop = builder.stop;
	...
	public void setStopDepartureOffset(final OptionalTime departureOffset) {
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof TransitRouteStopImplNew)) {
			return false;
		}
		TransitRouteStopImplNew other = (TransitRouteStopImplNew) obj;
		if (this.stop == null) {
	...
	public static final class Builder implements TransitRouteStop.Builder<Builder> {
		...
		public Builder(TransitRouteStopImplNew copy) {
		...
		public TransitRouteStopImplNew build() {
			return new TransitRouteStopImplNew(this);
		}
	}
}
